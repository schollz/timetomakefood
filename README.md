...
Note that ```chop``` is also used to divide depending on the number of pieces. If the number of pieces >99, then its chop. If its <30 it probably means to divide it into those proportions.
